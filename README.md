...
- Image is still a placeholder, and doesn't make use of "Art Direction" (separate image for mobile).
...
- Adding the Pagination controller. This is something I could hack out on my own, but using a MuiMaterials
one looked like a very nice presentation detail, and I got help with the exact syntax.
- I ran a prompt to see if I missed any test requirements, and it called out that I forgot to put metadata
on all pages.
